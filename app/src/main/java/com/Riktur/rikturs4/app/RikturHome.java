...
public class RikturHome extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riktur_home);
        ...
        String webViewUrl = "http://default-environment-a6v32mbbri.elasticbeanstalk.com/index";
    ...
    private void startWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                ...
                // if url contains string Riktur
                // Then show progress  Dialog
                if (progressDialog == null && url.contains("Riktur")
                        ) {

                    // in standard case YourActivity.this
                    progressDialog = new ProgressDialog(RikturHome.this);
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            // Get permission from user to allow Location services
